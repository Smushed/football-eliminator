            ...
            <div className='container-fluid'>
                <div className='row'>
                    <div className='col-sm-12 col-md-3 form-group'>
                        ...
                        <select className='form-select' value={seasonSelect} type='select' name='seasonSelect' onChange={handleChange}>
                        ...
                        <select className='form-select' value={weekSelect} type='select' name='weekSelect' onChange={handleChange}>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                        ...
                        <br />
                        <br />
                        <button className='btn btn-primary' onClick={() => showPlayerEditor()}>
                            Player Editor
                        </button>
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        <button className='btn btn-primary' onClick={() => getMatchups()}>Get Matchups</button>
                    </div>
